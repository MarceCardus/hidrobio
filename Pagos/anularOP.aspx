<%@ Page Title="Anular Orden de Pago" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="anularOP.aspx.vb" Inherits="hidrobio.anularOP" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="ajaxToolkit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
       <table border="1" class="nav-justified">
        <tr>
            <td colspan="2" style="font-size: x-large; background-color: #666666"><span style="color: #FFFFFF; background-color: #FF6600"><strong><span style="background-color: #666666">Anular Orden de Pago</span></strong></span></td>
        </tr>
        <tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Anulación de Orden de Pago</h5>
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" CellPadding="3" Width="620px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                            <Columns>
                                <asp:BoundField DataField="opCod" HeaderText="Nro OP" />
                                <asp:BoundField DataField="opFecha" HeaderText="Fecha" />
                                <asp:BoundField DataField="opTotal" HeaderText="Total" DataFormatString="{0:N0}" />
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvDetalle" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="gastosTotal" HeaderText="Monto Gasto" DataFormatString="{0:N0}" />
                                        <asp:BoundField DataField="comprasTotalFac" HeaderText="Monto Acopio" DataFormatString="{0:N0}" />
                                    </Columns>
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
                                    <PagerStyle BackColor="White" ForeColor="#000066" HorizontalAlign="Left" />
