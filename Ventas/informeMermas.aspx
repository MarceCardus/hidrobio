<%@ Page Title="Informe de Mermas" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="informeMermas.aspx.vb" Inherits="hidrobio.informeMermas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table border="1" class="nav-justified">
        <tr>
            <td colspan="2" style="font-size: x-large; background-color: #666666"><span style="font-weight: bold; color: #FFFFFF"><span style="background-color: #666666">Informe de </span></span><strong><span style="color: #FFFFFF; background-color: #666666">Mermas</span></strong></td>
        </tr>
        <tr>
