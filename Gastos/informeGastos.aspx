<%@ Page Title="Informe de Gastos" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="informeGastos.aspx.vb" Inherits="hidrobio.informeGastos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
       <table border="1" class="nav-justified">
        <tr>
            <td colspan="2" style="font-size: x-large; background-color: #666666"><span style="font-weight: bold; color: #FFFFFF"><span style="background-color: #666666">Informe Gastos</span></span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="height: 22px; ">Rubros</td>
            <td style="height: 22px">
