Public Class gastosCombustible
    ...
    Sub cargarRubros()
        ...
        Dim filtro As String = " WHERE rubroNombre = 'Combustible'"
    ...
    Protected Sub rblItem_SelectedIndexChanged(sender As Object, e As EventArgs) Handles rblItem.SelectedIndexChanged
        ...
        If gvDatos.Rows.Count = 0 Then
            ...
            fila("Movil") = ddlMovil.SelectedItem
            fila("movCod") = ddlMovil.SelectedValue
            fila("Chofer") = ddlChofer.SelectedItem
            fila("perCod") = ddlChofer.SelectedValue
    ...
    Protected Sub gvDatos_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvDatos.RowDataBound
        ...
        Try
            ...
            ElseIf (e.Row.RowType = DataControlRowType.Footer) Then
                ...
                e.Row.Cells(8).Text = totalE.ToString("N0")

                e.Row.Cells(9).Text = total5.ToString("N0")

                e.Row.Cells(10).Text = total10.ToString("N0")
                e.Row.Cells(11).Text = totalG.ToString("N0")
            ...
            If IsNumeric(coditem) Then
                ...
                For i = 0 To gvDatos.Rows.Count - 1
                    ...
                    Else
                        ...
                        fila("Impuesto") = 1
                    End If
                    mensaje1 = cgastos.InsertarGastosDetCombus(coditem, fila("Codigo"), fila("Impuesto"), CDec(txtcant.Text), CDbl(fila("10")),
                                                         CDbl(fila("5")), CDbl(fila("Excenta")), fila("movCod"), fila("perCod"))
