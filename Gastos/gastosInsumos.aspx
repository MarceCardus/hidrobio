<%@ Page Title="Gastos Insumos" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="gastosInsumos.aspx.vb" Inherits="hidrobio.gastosInsumos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width:100%;" border="1">
        <tr>
            <td class="text-left" style="color: #FFFFFF; background-color: #666666; height: 27px; font-size: large;" colspan="3"><strong>GASTOS INSUMOS</strong></td>
        </tr>
        <tr>
            <td class="text-left" style="color: #FFFFFF; width: 358px; background-color: #999999"><strong>Fecha</strong></td>
            <td class="text-left" style="color: #FFFFFF; background-color: #999999; width: 455px;"><strong>Nro Factura</strong></td>
        ...
        <tr class="text-white">
            ...
            <td class="text-left" style="height: 26px; background-color: #999999; font-weight: bold; width: 455px;">Rubro</td>
            <td class="text-left" style="height: 26px; background-color: #999999"><strong>Item</strong></td>
        </tr>
        <tr>
            <td style="width: 358px">
        ...
        <button type="button" runat="server"   onserverclick="gvProveedor_seleccionar"  data-dismiss="modal" class="btn btn-primary" >Seleccionar</button>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                    <ContentTemplate>
                        <asp:RadioButtonList ID="rblItem" runat="server" AutoPostBack="True" RepeatColumns="2" RepeatDirection="Horizontal">
                        </asp:RadioButtonList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            <td colspan="3">
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                     <ContentTemplate>
                      <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" CellPadding="3" Width="744px" ShowFooter="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                                    <Columns>
