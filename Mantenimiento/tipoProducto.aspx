<%@ Page Title="Tipo de Producto" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="tipoProducto.aspx.vb" Inherits="hidrobio.tipoProducto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table border="1" class="nav-justified">
        <tr>
            <td colspan="2" style="font-size: x-large; background-color: #666666"><strong><span style="color: #FFFFFF; background-color: #666666">Tipo de Productos</span></strong></td>
        </tr>
        <tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Modificación de Tipo de Producto</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        desea modificar el Tipo de Producto?
      </div>
        ...
        <tr>
            <td colspan="2">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvRubros" runat="server" AutoGenerateColumns="False" CellPadding="3" Width="498px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                            <Columns>
                                <asp:BoundField DataField="tipoProdCod" HeaderText="Código" />
