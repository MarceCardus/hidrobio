<%@ Page Title="Proveedores" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="proveedor.aspx.vb" Inherits="hidrobio.proveedor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table border="1" class="nav-justified">
        <tr>
            <td colspan="2" style="font-size: x-large; background-color: #666666"><strong><span style="color: #FFFFFF; background-color: #666666">Proveedores</span></strong></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="height: 22px; width: 219px">Acopio</td>
            <td style="height: 22px">
                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlAcopio" runat="server">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Modificación de Proveedores</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        desea modificar el Proveedor?
      </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" CellPadding="3" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                            <Columns>
                                <asp:BoundField DataField="provCod" HeaderText="Código" />
                                <asp:BoundField DataField="provRuc" HeaderText="RUC" />
                                <asp:BoundField DataField="provNombre" HeaderText="Descripción" />
                                <asp:BoundField DataField="provResponsable" HeaderText="Responsable" />
                                <asp:BoundField DataField="provTelef" HeaderText="Teléf" />
                                <asp:BoundField DataField="provAcopio" HeaderText="Acopio" />
                                <asp:BoundField DataField="provCoord" HeaderText="Coord" />
