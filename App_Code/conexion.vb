...
Public Class conexion
    Public Function conexionBD() As MySqlConnection
        ...
        Dim ConexionBaseDatos As String = "Database=alianza;Data Source=192.168.0.15;persistsecurityinfo=True;Allow Zero Datetime=True;Convert Zero Datetime=True;User Id='" & usuario & "';Password='" & password & "'"
