<%@ Page Title="Anular Cobros" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="anularCobros.aspx.vb" Inherits="hidrobio.anularCobros" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="ajaxToolkit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
       <table border="1" class="nav-justified">
        <tr>
            <td colspan="2" style="font-size: x-large; background-color: #666666"><span style="color: #FFFFFF; background-color: #FF6600"><strong><span style="background-color: #666666">Anular Cobro</span></strong></span></td>
        </tr>
        <tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Anulación de Cobros</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        desea anular el Cobro?
           <br />
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" CellPadding="3" Width="620px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                            <Columns>
                                <asp:BoundField DataField="cobroCod" HeaderText="Código" />
                                <asp:BoundField DataField="cobroFecha" HeaderText="Fecha" />
                                <asp:BoundField DataField="ventaCod" HeaderText="Cód Venta" />
                                <asp:BoundField DataField="ventaNroFact" HeaderText="Nro Fact" />
                                <asp:BoundField DataField="tPagoDesc" HeaderText="Tipo Pago" />
                                <asp:BoundField DataField="cobroMonto" HeaderText="Monto" />
