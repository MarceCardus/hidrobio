<%@ Page Title="Informe de Saldos de Clientes" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="infSaldoClie.aspx.vb" Inherits="hidrobio.infSaldoClie" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <table border="1" class="nav-justified">
        <tr>
            <td colspan="2" style="font-size: x-large; background-color: #666666"><span style="font-weight: bold; color: #FFFFFF"><span style="background-color: #666666">Informe Saldos por Cliente</span></span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="height: 22px; ">Cliente</td>
            <td style="height: 22px">
