<%@ Page Title="Informe de Empaquetados" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="informeEmpaquetados.aspx.vb" Inherits="hidrobio.informeEmpaquetados" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <table border="1" class="nav-justified">
        <tr>
            <td colspan="2" style="font-size: x-large; background-color: #666666"><span style="font-weight: bold; color: #FFFFFF"><span style="background-color: #666666">Informe de Empaquetados</span></span></td>
        </tr>
        <tr>
